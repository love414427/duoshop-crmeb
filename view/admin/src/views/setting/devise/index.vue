<template>
    <div class="diy-page">
        <div class="product_tabs">
            <div slot="title"> 
                <!--<el-button class="bnt" type="primary" icon="el-icon-arrow-left" @click="$router.back()">返回</el-button>-->
                <el-button class="bnt" type="primary" size="small" icon="el-icon-arrow-left" @click="goBack">返回</el-button>
                <div style="float: right;">
                    <el-button class="bnt" type="primary" @click="saveConfig" :loading="loading">保存</el-button>
                    ...
                    <div class="content">
                        <div class="contxt"
                            ...
                            <div class="scrollCon">
                             ...
                             <div class="overflowy" style="position:absolute;bottom:0;left:50%;margin-left:-193px;overflow:hidden;">
...
<script crossorigin='anonymous'>
    import {categoryList, diyGetInfo, diySave, getUrl, microGetInfo, microSave} from "@/api/diy";
    ...
    export default {
        ...
        created() {
            ...
            this.is_diy = this.$route.query.types == 1 ? true : false;
